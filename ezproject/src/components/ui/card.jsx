...
const SpecialCards = () => {
  const cards = [
    {
      frontIcon: <FaStar className="text-3xl" />, // React Icon for Star
    ...
    {
      frontIcon: <FaClock className="text-3xl" />, // React Icon for Clock
    ...
    {
      frontIcon: <FaRunning className="text-3xl" />, // React Icon for Running
    ...
    {
      frontIcon: <FaLock className="text-3xl" />, // React Icon for Lock (ISO)
